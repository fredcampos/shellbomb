...
public class DownloadServlet extends HttpServlet {
    ...
    private void processRequest(HttpServletRequest request, HttpServletResponse response, boolean content)
            throws IOException  {
        String requestedFile = getFilePathFromRequest(request);
        ...
        if (ifMatch != null && !matches(ifMatch, eTag)) {
            System.out.println(HttpServletResponse.SC_PRECONDITION_FAILED);
    ...
    private String getFilePathFromRequest(HttpServletRequest request) {
